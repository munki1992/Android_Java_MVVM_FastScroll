...
public class MainModule {
    ...
    MainViewModel createViewModel(GlobalApplication application) {
        return new MainViewModel(application, makeWordList());
    }

    /**
     * 단어 리스트 생성
     */
    private ObservableArrayList<String> makeWordList() {
        ObservableArrayList<String> wordList = new ObservableArrayList<>();
